...
return (new CustomEvent(event_name,(function (){var obj22500 = {"detail":data};
return obj22500;
})()));
} else {
...
var f = (function (){var pred__22507 = cljs.core._EQ_;
var expr__22508 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__22507.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__22508))){
return ((function (pred__22507,expr__22508){
return (function (p1__22501_SHARP_){
return console.warn(p1__22501_SHARP_);
});
;})(pred__22507,expr__22508))
} else {
if(cljs.core.truth_(pred__22507.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__22508))){
return ((function (pred__22507,expr__22508){
return (function (p1__22502_SHARP_){
return console.debug(p1__22502_SHARP_);
});
;})(pred__22507,expr__22508))
} else {
if(cljs.core.truth_(pred__22507.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__22508))){
return ((function (pred__22507,expr__22508){
return (function (p1__22503_SHARP_){
return console.error(p1__22503_SHARP_);
});
;})(pred__22507,expr__22508))
} else {
return ((function (pred__22507,expr__22508){
return (function (p1__22504_SHARP_){
return console.log(p1__22504_SHARP_);
});
;})(pred__22507,expr__22508))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__22511){
var map__22512 = p__22511;
var map__22512__$1 = ((((!((map__22512 == null)))?((((map__22512.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22512.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22512):map__22512);
var opts = map__22512__$1;
var eval_fn = cljs.core.get.call(null,map__22512__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__22514_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__22516,(0),null);
var v = cljs.core.nth.call(null,vec__22516,(1),null);
...
}catch (e22521){if((e22521 instanceof Error)){
var e = e22521;
return not_found;
} else {
throw e22521;
...
//# sourceMappingURL=utils.js.map?rel=1506616994247
