...
var or__58161__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj69222 = {"detail":data};
return obj69222;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__58149__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__58149__auto__)){
var and__58149__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__69229 = cljs.core._EQ_;
var expr__69230 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__69229.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__69230))){
return ((function (pred__69229,expr__69230){
return (function (p1__69223_SHARP_){
return console.warn(p1__69223_SHARP_);
});
;})(pred__69229,expr__69230))
} else {
if(cljs.core.truth_(pred__69229.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__69230))){
return ((function (pred__69229,expr__69230){
return (function (p1__69224_SHARP_){
return console.debug(p1__69224_SHARP_);
});
;})(pred__69229,expr__69230))
} else {
if(cljs.core.truth_(pred__69229.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__69230))){
return ((function (pred__69229,expr__69230){
return (function (p1__69225_SHARP_){
return console.error(p1__69225_SHARP_);
});
;})(pred__69229,expr__69230))
} else {
return ((function (pred__69229,expr__69230){
return (function (p1__69226_SHARP_){
return console.log(p1__69226_SHARP_);
});
;})(pred__69229,expr__69230))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__69233){
var map__69234 = p__69233;
var map__69234__$1 = ((((!((map__69234 == null)))?((((map__69234.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__69234.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__69234):map__69234);
var opts = map__69234__$1;
var eval_fn = cljs.core.get.call(null,map__69234__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__69236_SHARP_){
return new_def.callback(p1__69236_SHARP_);
});})(new_def))
);
...
return (function (p__69237){
var vec__69238 = p__69237;
var ky = cljs.core.nth.call(null,vec__69238,(0),null);
var v = cljs.core.nth.call(null,vec__69238,(1),null);
...
if(cljs.core.truth_((function (){var and__58149__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1505406790174
