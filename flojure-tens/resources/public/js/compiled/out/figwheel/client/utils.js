...
return (new CustomEvent(event_name,(function (){var obj22466 = {"detail":data};
return obj22466;
})()));
} else {
...
var f = (function (){var pred__22473 = cljs.core._EQ_;
var expr__22474 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__22473.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__22474))){
return ((function (pred__22473,expr__22474){
return (function (p1__22467_SHARP_){
return console.warn(p1__22467_SHARP_);
});
;})(pred__22473,expr__22474))
} else {
if(cljs.core.truth_(pred__22473.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__22474))){
return ((function (pred__22473,expr__22474){
return (function (p1__22468_SHARP_){
return console.debug(p1__22468_SHARP_);
});
;})(pred__22473,expr__22474))
} else {
if(cljs.core.truth_(pred__22473.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__22474))){
return ((function (pred__22473,expr__22474){
return (function (p1__22469_SHARP_){
return console.error(p1__22469_SHARP_);
});
;})(pred__22473,expr__22474))
} else {
return ((function (pred__22473,expr__22474){
return (function (p1__22470_SHARP_){
return console.log(p1__22470_SHARP_);
});
;})(pred__22473,expr__22474))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__22477){
...
var opts = map__22478__$1;
var eval_fn = cljs.core.get.call(null,map__22478__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__22480_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__22482,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1504894095501
