...
var or__64417__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj76411 = {"detail":data};
return obj76411;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__64405__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__64405__auto__)){
var and__64405__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__76418 = cljs.core._EQ_;
var expr__76419 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__76418.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__76419))){
return ((function (pred__76418,expr__76419){
return (function (p1__76412_SHARP_){
return console.warn(p1__76412_SHARP_);
});
;})(pred__76418,expr__76419))
} else {
if(cljs.core.truth_(pred__76418.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__76419))){
return ((function (pred__76418,expr__76419){
return (function (p1__76413_SHARP_){
return console.debug(p1__76413_SHARP_);
});
;})(pred__76418,expr__76419))
} else {
if(cljs.core.truth_(pred__76418.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__76419))){
return ((function (pred__76418,expr__76419){
return (function (p1__76414_SHARP_){
return console.error(p1__76414_SHARP_);
});
;})(pred__76418,expr__76419))
} else {
return ((function (pred__76418,expr__76419){
return (function (p1__76415_SHARP_){
return console.log(p1__76415_SHARP_);
});
;})(pred__76418,expr__76419))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__76422){
var map__76423 = p__76422;
var map__76423__$1 = ((((!((map__76423 == null)))?((((map__76423.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76423.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__76423):map__76423);
var opts = map__76423__$1;
var eval_fn = cljs.core.get.call(null,map__76423__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__76425_SHARP_){
return new_def.callback(p1__76425_SHARP_);
});})(new_def))
);
...
return (function (p__76426){
var vec__76427 = p__76426;
var ky = cljs.core.nth.call(null,vec__76427,(0),null);
var v = cljs.core.nth.call(null,vec__76427,(1),null);
...
if(cljs.core.truth_((function (){var and__64405__auto__ = typeof localStorage !== 'undefined';
...
}catch (e76432){if((e76432 instanceof Error)){
var e = e76432;
return not_found;
} else {
throw e76432;
...
//# sourceMappingURL=utils.js.map?rel=1506558354388
