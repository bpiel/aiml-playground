...
var or__58128__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj116850 = {"detail":data};
return obj116850;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__58116__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__58116__auto__)){
var and__58116__auto____$1 = goog.object.get(window,"CustomEvent");
...
var G__116856 = arguments.length;
switch (G__116856) {
case 1:
...
var f = (function (){var pred__116857 = cljs.core._EQ_;
var expr__116858 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__116857.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__116858))){
return ((function (pred__116857,expr__116858){
return (function (p1__116851_SHARP_){
return console.warn(p1__116851_SHARP_);
});
;})(pred__116857,expr__116858))
} else {
if(cljs.core.truth_(pred__116857.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__116858))){
return ((function (pred__116857,expr__116858){
return (function (p1__116852_SHARP_){
return console.debug(p1__116852_SHARP_);
});
;})(pred__116857,expr__116858))
} else {
if(cljs.core.truth_(pred__116857.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__116858))){
return ((function (pred__116857,expr__116858){
return (function (p1__116853_SHARP_){
return console.error(p1__116853_SHARP_);
});
;})(pred__116857,expr__116858))
} else {
return ((function (pred__116857,expr__116858){
return (function (p1__116854_SHARP_){
return console.log(p1__116854_SHARP_);
});
;})(pred__116857,expr__116858))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__116861){
var map__116862 = p__116861;
var map__116862__$1 = ((((!((map__116862 == null)))?((((map__116862.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__116862.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__116862):map__116862);
var opts = map__116862__$1;
var eval_fn = cljs.core.get.call(null,map__116862__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__116864_SHARP_){
return new_def.callback(p1__116864_SHARP_);
});})(new_def))
);
...
return (function (p__116865){
var vec__116866 = p__116865;
var ky = cljs.core.nth.call(null,vec__116866,(0),null);
var v = cljs.core.nth.call(null,vec__116866,(1),null);
...
var G__116870 = arguments.length;
switch (G__116870) {
case 2:
...
if(cljs.core.truth_((function (){var and__58116__auto__ = typeof localStorage !== 'undefined';
...
}catch (e116871){if((e116871 instanceof Error)){
var e = e116871;
return not_found;
} else {
throw e116871;
...
//# sourceMappingURL=utils.js.map?rel=1505927829710
