...
var or__58135__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj70129 = {"detail":data};
return obj70129;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__58123__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__58123__auto__)){
var and__58123__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__70136 = cljs.core._EQ_;
var expr__70137 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__70136.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__70137))){
return ((function (pred__70136,expr__70137){
return (function (p1__70130_SHARP_){
return console.warn(p1__70130_SHARP_);
});
;})(pred__70136,expr__70137))
} else {
if(cljs.core.truth_(pred__70136.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__70137))){
return ((function (pred__70136,expr__70137){
return (function (p1__70131_SHARP_){
return console.debug(p1__70131_SHARP_);
});
;})(pred__70136,expr__70137))
} else {
if(cljs.core.truth_(pred__70136.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__70137))){
return ((function (pred__70136,expr__70137){
return (function (p1__70132_SHARP_){
return console.error(p1__70132_SHARP_);
});
;})(pred__70136,expr__70137))
} else {
return ((function (pred__70136,expr__70137){
return (function (p1__70133_SHARP_){
return console.log(p1__70133_SHARP_);
});
;})(pred__70136,expr__70137))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__70140){
var map__70141 = p__70140;
var map__70141__$1 = ((((!((map__70141 == null)))?((((map__70141.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70141.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__70141):map__70141);
var opts = map__70141__$1;
var eval_fn = cljs.core.get.call(null,map__70141__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__70143_SHARP_){
return new_def.callback(p1__70143_SHARP_);
});})(new_def))
);
...
return (function (p__70144){
var vec__70145 = p__70144;
var ky = cljs.core.nth.call(null,vec__70145,(0),null);
var v = cljs.core.nth.call(null,vec__70145,(1),null);
...
if(cljs.core.truth_((function (){var and__58123__auto__ = typeof localStorage !== 'undefined';
...
}catch (e70150){if((e70150 instanceof Error)){
var e = e70150;
return not_found;
} else {
throw e70150;
...
//# sourceMappingURL=utils.js.map?rel=1506641516195
