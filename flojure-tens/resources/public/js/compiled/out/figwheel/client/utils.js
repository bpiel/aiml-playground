...
return (new CustomEvent(event_name,(function (){var obj19919 = {"detail":data};
return obj19919;
})()));
} else {
...
var f = (function (){var pred__19926 = cljs.core._EQ_;
var expr__19927 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__19926.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__19927))){
return ((function (pred__19926,expr__19927){
return (function (p1__19920_SHARP_){
return console.warn(p1__19920_SHARP_);
});
;})(pred__19926,expr__19927))
} else {
if(cljs.core.truth_(pred__19926.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__19927))){
return ((function (pred__19926,expr__19927){
return (function (p1__19921_SHARP_){
return console.debug(p1__19921_SHARP_);
});
;})(pred__19926,expr__19927))
} else {
if(cljs.core.truth_(pred__19926.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__19927))){
return ((function (pred__19926,expr__19927){
return (function (p1__19922_SHARP_){
return console.error(p1__19922_SHARP_);
});
;})(pred__19926,expr__19927))
} else {
return ((function (pred__19926,expr__19927){
return (function (p1__19923_SHARP_){
return console.log(p1__19923_SHARP_);
});
;})(pred__19926,expr__19927))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__19930){
var map__19931 = p__19930;
var map__19931__$1 = ((((!((map__19931 == null)))?((((map__19931.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19931.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19931):map__19931);
var opts = map__19931__$1;
var eval_fn = cljs.core.get.call(null,map__19931__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__19933_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__19935,(0),null);
var v = cljs.core.nth.call(null,vec__19935,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1504285960690
