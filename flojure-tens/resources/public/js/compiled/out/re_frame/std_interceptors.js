...
var vec__66561_66564 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_66565 = cljs.core.nth.call(null,vec__66561_66564,(0),null);
var only_after_66566 = cljs.core.nth.call(null,vec__66561_66564,(1),null);
var db_changed_QMARK__66567 = (!((only_before_66565 == null))) || (!((only_after_66566 == null)));
if(db_changed_QMARK__66567){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_66565);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_66566);
...
var map__66568 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__66568__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__66568__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__66570 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__66570__$1 = ((((!((map__66570 == null)))?((((map__66570.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66570.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__66570):map__66570);
var coeffects = map__66570__$1;
var event = cljs.core.get.call(null,map__66570__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__59412__auto___66573 = arguments.length;
var i__59413__auto___66574 = (0);
while(true){
if((i__59413__auto___66574 < len__59412__auto___66573)){
args__59419__auto__.push((arguments[i__59413__auto___66574]));

var G__66575 = (i__59413__auto___66574 + (1));
i__59413__auto___66574 = G__66575;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__59420__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq66572){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq66572));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__58135__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__59419__auto__ = [];
var len__59412__auto___66581 = arguments.length;
var i__59413__auto___66582 = (0);
while(true){
if((i__59413__auto___66582 < len__59412__auto___66581)){
args__59419__auto__.push((arguments[i__59413__auto___66582]));

var G__66583 = (i__59413__auto___66582 + (1));
i__59413__auto___66582 = G__66583;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__59420__auto__);
});
...
return (function (p1__66576_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__66576_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__66577_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__66577_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__58123__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq66578){
var G__66579 = cljs.core.first.call(null,seq66578);
var seq66578__$1 = cljs.core.next.call(null,seq66578);
var G__66580 = cljs.core.first.call(null,seq66578__$1);
var seq66578__$2 = cljs.core.next.call(null,seq66578__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__66579,G__66580,seq66578__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1506641509681
