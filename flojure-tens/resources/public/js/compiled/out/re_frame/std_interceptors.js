...
var vec__18932_18935 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_18936 = cljs.core.nth.call(null,vec__18932_18935,(0),null);
var only_after_18937 = cljs.core.nth.call(null,vec__18932_18935,(1),null);
var db_changed_QMARK__18938 = (!((only_before_18936 == null))) || (!((only_after_18937 == null)));
if(db_changed_QMARK__18938){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_18936);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_18937);
...
var map__18939 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__18939__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__18939__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__18941 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__18941__$1;
var event = cljs.core.get.call(null,map__18941__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__11087__auto___18944 = arguments.length;
var i__11088__auto___18945 = (0);
while(true){
if((i__11088__auto___18945 < len__11087__auto___18944)){
args__11094__auto__.push((arguments[i__11088__auto___18945]));

var G__18946 = (i__11088__auto___18945 + (1));
i__11088__auto___18945 = G__18946;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq18943){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq18943));
});
...
var args__11094__auto__ = [];
var len__11087__auto___18952 = arguments.length;
var i__11088__auto___18953 = (0);
while(true){
if((i__11088__auto___18953 < len__11087__auto___18952)){
args__11094__auto__.push((arguments[i__11088__auto___18953]));

var G__18954 = (i__11088__auto___18953 + (1));
i__11088__auto___18953 = G__18954;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__18947_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__18948_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__18948_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq18949){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__18950,G__18951,seq18949__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1506616989901
