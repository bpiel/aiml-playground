...
var vec__114039_114042 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_114043 = cljs.core.nth.call(null,vec__114039_114042,(0),null);
var only_after_114044 = cljs.core.nth.call(null,vec__114039_114042,(1),null);
var db_changed_QMARK__114045 = (!((only_before_114043 == null))) || (!((only_after_114044 == null)));
if(db_changed_QMARK__114045){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_114043);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_114044);
...
var map__114046 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__114046__$1 = ((((!((map__114046 == null)))?((((map__114046.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__114046.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__114046):map__114046);
var db = cljs.core.get.call(null,map__114046__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__114046__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__114048 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__114048__$1 = ((((!((map__114048 == null)))?((((map__114048.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__114048.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__114048):map__114048);
var coeffects = map__114048__$1;
var event = cljs.core.get.call(null,map__114048__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__59405__auto___114051 = arguments.length;
var i__59406__auto___114052 = (0);
while(true){
if((i__59406__auto___114052 < len__59405__auto___114051)){
args__59412__auto__.push((arguments[i__59406__auto___114052]));

var G__114053 = (i__59406__auto___114052 + (1));
i__59406__auto___114052 = G__114053;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__59413__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq114050){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq114050));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__58128__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__59412__auto__ = [];
var len__59405__auto___114059 = arguments.length;
var i__59406__auto___114060 = (0);
while(true){
if((i__59406__auto___114060 < len__59405__auto___114059)){
args__59412__auto__.push((arguments[i__59406__auto___114060]));

var G__114061 = (i__59406__auto___114060 + (1));
i__59406__auto___114060 = G__114061;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__59413__auto__);
});
...
return (function (p1__114054_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__114054_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__114055_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__114055_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__58116__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq114056){
var G__114057 = cljs.core.first.call(null,seq114056);
var seq114056__$1 = cljs.core.next.call(null,seq114056);
var G__114058 = cljs.core.first.call(null,seq114056__$1);
var seq114056__$2 = cljs.core.next.call(null,seq114056__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__114057,G__114058,seq114056__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1505927823670
