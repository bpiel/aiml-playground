...
var vec__23511_23514 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_23515 = cljs.core.nth.call(null,vec__23511_23514,(0),null);
var only_after_23516 = cljs.core.nth.call(null,vec__23511_23514,(1),null);
var db_changed_QMARK__23517 = (!((only_before_23515 == null))) || (!((only_after_23516 == null)));
if(db_changed_QMARK__23517){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_23515);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_23516);
...
var map__23518 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__23518__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__23518__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__23520 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__23520__$1;
var event = cljs.core.get.call(null,map__23520__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__11087__auto___23523 = arguments.length;
var i__11088__auto___23524 = (0);
while(true){
if((i__11088__auto___23524 < len__11087__auto___23523)){
args__11094__auto__.push((arguments[i__11088__auto___23524]));

var G__23525 = (i__11088__auto___23524 + (1));
i__11088__auto___23524 = G__23525;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq23522){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq23522));
});
...
var args__11094__auto__ = [];
var len__11087__auto___23531 = arguments.length;
var i__11088__auto___23532 = (0);
while(true){
if((i__11088__auto___23532 < len__11087__auto___23531)){
args__11094__auto__.push((arguments[i__11088__auto___23532]));

var G__23533 = (i__11088__auto___23532 + (1));
i__11088__auto___23532 = G__23533;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__23526_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__23527_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__23527_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq23528){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__23529,G__23530,seq23528__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1504285965107
