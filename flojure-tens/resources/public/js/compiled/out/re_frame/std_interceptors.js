...
var vec__21552_21555 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_21556 = cljs.core.nth.call(null,vec__21552_21555,(0),null);
var only_after_21557 = cljs.core.nth.call(null,vec__21552_21555,(1),null);
var db_changed_QMARK__21558 = (!((only_before_21556 == null))) || (!((only_after_21557 == null)));
if(db_changed_QMARK__21558){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_21556);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_21557);
...
var map__21559 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__21559__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__21559__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__21561 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__21561__$1;
var event = cljs.core.get.call(null,map__21561__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__11087__auto___21564 = arguments.length;
var i__11088__auto___21565 = (0);
while(true){
if((i__11088__auto___21565 < len__11087__auto___21564)){
args__11094__auto__.push((arguments[i__11088__auto___21565]));

var G__21566 = (i__11088__auto___21565 + (1));
i__11088__auto___21565 = G__21566;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq21563){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21563));
});
...
var args__11094__auto__ = [];
var len__11087__auto___21572 = arguments.length;
var i__11088__auto___21573 = (0);
while(true){
if((i__11088__auto___21573 < len__11087__auto___21572)){
args__11094__auto__.push((arguments[i__11088__auto___21573]));

var G__21574 = (i__11088__auto___21573 + (1));
i__11088__auto___21573 = G__21574;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__21567_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__21568_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__21568_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq21569){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__21570,G__21571,seq21569__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1505782686231
