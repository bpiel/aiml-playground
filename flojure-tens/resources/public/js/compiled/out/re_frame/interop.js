...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__72411 = cljs.core.instance_QMARK_;
var expr__72412 = reactive_val;
if(cljs.core.truth_(pred__72411.call(null,reagent.ratom.RAtom,expr__72412))){
return "ra";
} else {
if(cljs.core.truth_(pred__72411.call(null,reagent.ratom.RCursor,expr__72412))){
return "rc";
} else {
if(cljs.core.truth_(pred__72411.call(null,reagent.ratom.Reaction,expr__72412))){
return "rx";
} else {
if(cljs.core.truth_(pred__72411.call(null,reagent.ratom.Track,expr__72412))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1506558346246
