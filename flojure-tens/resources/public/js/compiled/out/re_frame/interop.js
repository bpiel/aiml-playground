...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__113750 = cljs.core.instance_QMARK_;
var expr__113751 = reactive_val;
if(cljs.core.truth_(pred__113750.call(null,reagent.ratom.RAtom,expr__113751))){
return "ra";
} else {
if(cljs.core.truth_(pred__113750.call(null,reagent.ratom.RCursor,expr__113751))){
return "rc";
} else {
if(cljs.core.truth_(pred__113750.call(null,reagent.ratom.Reaction,expr__113751))){
return "rx";
} else {
if(cljs.core.truth_(pred__113750.call(null,reagent.ratom.Track,expr__113751))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1505927822986
