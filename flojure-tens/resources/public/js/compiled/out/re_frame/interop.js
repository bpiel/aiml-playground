...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__66130 = cljs.core.instance_QMARK_;
var expr__66131 = reactive_val;
if(cljs.core.truth_(pred__66130.call(null,reagent.ratom.RAtom,expr__66131))){
return "ra";
} else {
if(cljs.core.truth_(pred__66130.call(null,reagent.ratom.RCursor,expr__66131))){
return "rc";
} else {
if(cljs.core.truth_(pred__66130.call(null,reagent.ratom.Reaction,expr__66131))){
return "rx";
} else {
if(cljs.core.truth_(pred__66130.call(null,reagent.ratom.Track,expr__66131))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1506641508910
