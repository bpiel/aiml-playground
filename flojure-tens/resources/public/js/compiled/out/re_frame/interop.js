...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__60631 = cljs.core.instance_QMARK_;
var expr__60632 = reactive_val;
if(cljs.core.truth_(pred__60631.call(null,reagent.ratom.RAtom,expr__60632))){
return "ra";
} else {
if(cljs.core.truth_(pred__60631.call(null,reagent.ratom.RCursor,expr__60632))){
return "rc";
} else {
if(cljs.core.truth_(pred__60631.call(null,reagent.ratom.Reaction,expr__60632))){
return "rx";
} else {
if(cljs.core.truth_(pred__60631.call(null,reagent.ratom.Track,expr__60632))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1505406775800
