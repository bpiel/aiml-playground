...
var o71570 = temp__6736__auto__;
var temp__6736__auto____$1 = (o71570["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o71571 = temp__6736__auto____$1;
return (o71571["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__60650__auto__ = f;
return (o__60650__auto__["toString"]).call(o__60650__auto__);
} else {
return "";
}
}catch (e71572){var _ = e71572;
return "";
}});
...
try{var o__60650__auto___71574 = t;
(o__60650__auto___71574["cljs$lang$ctorPrWriter"]).call(o__60650__auto___71574,t,writer);
}catch (e71573){var __71575 = e71573;
}
...
var char_code = (function (){var o__60650__auto__ = (new String(char$));
return (o__60650__auto__["charCodeAt"]).call(o__60650__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__60650__auto__ = String;
return (o__60650__auto__["fromCharCode"]).call(o__60650__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__71576 = num_code;
switch (G__71576) {
case (1):
return (185);
...
var o__60650__auto__ = String;
return (o__60650__auto__["fromCharCode"]).call(o__60650__auto__,superscript_code);
});
/**
...
}catch (e71578){var _e__60657__auto__ = e71578;
return false;
}})())){
...
var vec__71579 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__71579,(0),null);
...
var or__58161__auto__ = (function (){var temp__6736__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__6736__auto__)){
...
if(cljs.core.truth_(temp__6736__auto__)){
var o71582 = temp__6736__auto__;
var temp__6736__auto____$1 = (o71582["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o71583 = temp__6736__auto____$1;
return (o71583["nameToPath"]);
} else {
return null;
}
} else {
...
var len__59438__auto___71590 = arguments.length;
var i__59439__auto___71591 = (0);
while(true){
if((i__59439__auto___71591 < len__59438__auto___71590)){
args__59445__auto__.push((arguments[i__59439__auto___71591]));

var G__71592 = (i__59439__auto___71591 + (1));
i__59439__auto___71591 = G__71592;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__59446__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__71586){
var vec__71587 = p__71586;
var ns_detector = cljs.core.nth.call(null,vec__71587,(0),null);
var effective_detector = (function (){var or__58161__auto__ = ns_detector;
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
...
var G__71593 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__71594 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__71593;
remaining_tokens = G__71594;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq71584){
var G__71585 = cljs.core.first.call(null,seq71584);
var seq71584__$1 = cljs.core.next.call(null,seq71584);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__71585,seq71584__$1);
});
...
var vec__71598 = cljs.core.split_with.call(null,(function (p1__71597_SHARP_){
return cljs.core.not_EQ_.call(null,p1__71597_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__71598,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__71598,(1),null);
...
var vec__71601 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__71601,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__71601,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__71604 = cljs.core.rest.call(null,remaining_tokens);
var G__71605 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__71604;
name_tokens = G__71605;
continue;
} else {
...
var vec__71608 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__71608,(0),null);
var arity = cljs.core.nth.call(null,vec__71608,(1),null);
var vec__71611 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__71611,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__71611,(1),null);
var vec__71614 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__71614,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__71614,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__71614,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__71614,(3),null);
...
var vec__71620 = result;
var munged_ns = cljs.core.nth.call(null,vec__71620,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__71620,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__71620,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__71620,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__71620,(4),null);
var arity = cljs.core.nth.call(null,vec__71620,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__71624 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__71624,(0),null);
var args = cljs.core.nth.call(null,vec__71624,(1),null);
var vec__71627 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__71627,(0),null);
var name = cljs.core.nth.call(null,vec__71627,(1),null);
...
var G__71630 = (arity + (1));
var G__71631 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__71632){
var vec__71633 = p__71632;
var arity = cljs.core.nth.call(null,vec__71633,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__71633,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__58161__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
...
return (function (p1__71636_SHARP_){
return cljs.core.get.call(null,arities,p1__71636_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__71637_SHARP_){
return cljs.core.drop.call(null,(2),p1__71637_SHARP_);
...
var args__59445__auto__ = [];
var len__59438__auto___71644 = arguments.length;
var i__59439__auto___71645 = (0);
while(true){
if((i__59439__auto___71645 < len__59438__auto___71644)){
args__59445__auto__.push((arguments[i__59439__auto___71645]));

var G__71646 = (i__59439__auto___71645 + (1));
i__59439__auto___71645 = G__71646;
continue;
} else {
}
break;
...
var argseq__59446__auto__ = ((((1) < args__59445__auto__.length))?(new cljs.core.IndexedSeq(args__59445__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__59446__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__71640){
var vec__71641 = p__71640;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__71641,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq71638){
var G__71639 = cljs.core.first.call(null,seq71638);
var seq71638__$1 = cljs.core.next.call(null,seq71638);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__71639,seq71638__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__58161__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__58149__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__58161__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
...
var map__71649 = options;
var map__71649__$1 = ((((!((map__71649 == null)))?((((map__71649.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71649.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__71649):map__71649);
var include_ns_QMARK_ = cljs.core.get.call(null,map__71649__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__71649__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__71649__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__71649__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__71650 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__71650,(0),null);
var fn_name = cljs.core.nth.call(null,vec__71650,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__71650,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__71650,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__71650,(4),null);
var arity = cljs.core.nth.call(null,vec__71650,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__58149__auto__ = protocol_ns;
if(cljs.core.truth_(and__58149__auto__)){
return cljs.core.not.call(null,(function (){var and__58149__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__58161__auto__ = protocol_part;
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
return fn_part;
...
var o__60650__auto__ = f;
return (o__60650__auto__["getBasis"]).call(o__60650__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__58149__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__58149__auto__)){
...
}catch (e71654){var _e__60657__auto__ = e71654;
...
var G__71655 = (obj[cljs.core.first.call(null,path)]);
var G__71656 = cljs.core.rest.call(null,path);
obj = G__71655;
path = G__71656;
continue;
} else {
...
var partition_bits = (function (){var or__58161__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
return (0);
...
return (function (accum,p__71657){
var vec__71658 = p__71657;
var bit = cljs.core.nth.call(null,vec__71658,(0),null);
var protocol = cljs.core.nth.call(null,vec__71658,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__71661){
var vec__71662 = p__71661;
var ns = cljs.core.nth.call(null,vec__71662,(0),null);
var name = cljs.core.nth.call(null,vec__71662,(1),null);
var selector = cljs.core.nth.call(null,vec__71662,(2),null);
...
return (function (p__71666){
var vec__71667 = p__71666;
var munged_name = cljs.core.nth.call(null,vec__71667,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__71667,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__71667,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__71665_SHARP_){
return (obj[cljs.core.first.call(null,p1__71665_SHARP_)]);
});})(name,sorted_matches,vec__71667,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1505406794283
