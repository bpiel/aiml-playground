...
var o25509 = temp__6736__auto__;
var temp__6736__auto____$1 = (o25509["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o25510 = temp__6736__auto____$1;
return (o25510["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__19323__auto___25513 = t;
(o__19323__auto___25513["cljs$lang$ctorPrWriter"]).call(o__19323__auto___25513,t,writer);
}catch (e25512){var __25514 = e25512;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25515 = num_code;
switch (G__25515) {
case (1):
return (185);
...
}catch (e25517){var _e__19330__auto__ = e25517;
return false;
}})())){
...
var vec__25518 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25518,(0),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var o25521 = temp__6736__auto__;
var temp__6736__auto____$1 = (o25521["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o25522 = temp__6736__auto____$1;
return (o25522["nameToPath"]);
} else {
return null;
}
} else {
...
var len__11087__auto___25529 = arguments.length;
var i__11088__auto___25530 = (0);
while(true){
if((i__11088__auto___25530 < len__11087__auto___25529)){
args__11094__auto__.push((arguments[i__11088__auto___25530]));

var G__25531 = (i__11088__auto___25530 + (1));
i__11088__auto___25530 = G__25531;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25525){
var vec__25526 = p__25525;
var ns_detector = cljs.core.nth.call(null,vec__25526,(0),null);
...
var G__25532 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25533 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25532;
remaining_tokens = G__25533;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25523){
var G__25524 = cljs.core.first.call(null,seq25523);
var seq25523__$1 = cljs.core.next.call(null,seq25523);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__25524,seq25523__$1);
});
...
var vec__25537 = cljs.core.split_with.call(null,(function (p1__25536_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25536_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25537,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25537,(1),null);
...
var vec__25540 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25540,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25540,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25543 = cljs.core.rest.call(null,remaining_tokens);
var G__25544 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25543;
name_tokens = G__25544;
continue;
} else {
...
var vec__25547 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25547,(0),null);
var arity = cljs.core.nth.call(null,vec__25547,(1),null);
var vec__25550 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25550,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25550,(1),null);
var vec__25553 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25553,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25553,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25553,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25553,(3),null);
...
var vec__25559 = result;
var munged_ns = cljs.core.nth.call(null,vec__25559,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25559,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25559,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25559,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25559,(4),null);
var arity = cljs.core.nth.call(null,vec__25559,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__25563 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__25563,(0),null);
var args = cljs.core.nth.call(null,vec__25563,(1),null);
var vec__25566 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25566,(0),null);
var name = cljs.core.nth.call(null,vec__25566,(1),null);
...
var G__25569 = (arity + (1));
var G__25570 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25571){
var vec__25572 = p__25571;
var arity = cljs.core.nth.call(null,vec__25572,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25572,(1),null);
...
return cljs.core.get.call(null,arities,p1__25575_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25576_SHARP_);
...
var args__11094__auto__ = [];
var len__11087__auto___25583 = arguments.length;
var i__11088__auto___25584 = (0);
while(true){
if((i__11088__auto___25584 < len__11087__auto___25583)){
args__11094__auto__.push((arguments[i__11088__auto___25584]));

var G__25585 = (i__11088__auto___25584 + (1));
i__11088__auto___25584 = G__25585;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25579){
var vec__25580 = p__25579;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25580,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25577){
var G__25578 = cljs.core.first.call(null,seq25577);
var seq25577__$1 = cljs.core.next.call(null,seq25577);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__25578,seq25577__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25588__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25588__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25588__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25588__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25589 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25589,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25589,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25589,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25589,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25589,(4),null);
var arity = cljs.core.nth.call(null,vec__25589,(5),null);
...
}catch (e25593){var _e__19330__auto__ = e25593;
...
var G__25594 = (obj[cljs.core.first.call(null,path)]);
var G__25595 = cljs.core.rest.call(null,path);
obj = G__25594;
path = G__25595;
continue;
} else {
...
return (function (accum,p__25596){
var vec__25597 = p__25596;
var bit = cljs.core.nth.call(null,vec__25597,(0),null);
var protocol = cljs.core.nth.call(null,vec__25597,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25600){
var vec__25601 = p__25600;
var ns = cljs.core.nth.call(null,vec__25601,(0),null);
var name = cljs.core.nth.call(null,vec__25601,(1),null);
var selector = cljs.core.nth.call(null,vec__25601,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__25606,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25606,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25606,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25604_SHARP_){
return (obj[cljs.core.first.call(null,p1__25604_SHARP_)]);
});})(name,sorted_matches,vec__25606,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1506616996881
