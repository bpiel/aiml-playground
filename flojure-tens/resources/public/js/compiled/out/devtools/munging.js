...
var o24543 = temp__6736__auto__;
var temp__6736__auto____$1 = (o24543["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o24544 = temp__6736__auto____$1;
return (o24544["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__12357__auto__ = f;
return (o__12357__auto__["toString"]).call(o__12357__auto__);
} else {
return "";
}
}catch (e24545){var _ = e24545;
return "";
}});
...
try{var o__12357__auto___24547 = t;
(o__12357__auto___24547["cljs$lang$ctorPrWriter"]).call(o__12357__auto___24547,t,writer);
}catch (e24546){var __24548 = e24546;
}
...
var char_code = (function (){var o__12357__auto__ = (new String(char$));
return (o__12357__auto__["charCodeAt"]).call(o__12357__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12357__auto__ = String;
return (o__12357__auto__["fromCharCode"]).call(o__12357__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24549 = num_code;
switch (G__24549) {
case (1):
return (185);
...
var o__12357__auto__ = String;
return (o__12357__auto__["fromCharCode"]).call(o__12357__auto__,superscript_code);
});
/**
...
}catch (e24551){var _e__12364__auto__ = e24551;
return false;
}})())){
...
var vec__24552 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24552,(0),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var o24555 = temp__6736__auto__;
var temp__6736__auto____$1 = (o24555["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o24556 = temp__6736__auto____$1;
return (o24556["nameToPath"]);
} else {
return null;
}
} else {
...
var len__11087__auto___24563 = arguments.length;
var i__11088__auto___24564 = (0);
while(true){
if((i__11088__auto___24564 < len__11087__auto___24563)){
args__11094__auto__.push((arguments[i__11088__auto___24564]));

var G__24565 = (i__11088__auto___24564 + (1));
i__11088__auto___24564 = G__24565;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24559){
var vec__24560 = p__24559;
var ns_detector = cljs.core.nth.call(null,vec__24560,(0),null);
...
var G__24566 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24567 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24566;
remaining_tokens = G__24567;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24557){
var G__24558 = cljs.core.first.call(null,seq24557);
var seq24557__$1 = cljs.core.next.call(null,seq24557);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__24558,seq24557__$1);
});
...
var vec__24571 = cljs.core.split_with.call(null,(function (p1__24570_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24570_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24571,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24571,(1),null);
...
var vec__24574 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24574,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24574,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24577 = cljs.core.rest.call(null,remaining_tokens);
var G__24578 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24577;
name_tokens = G__24578;
continue;
} else {
...
var vec__24581 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24581,(0),null);
var arity = cljs.core.nth.call(null,vec__24581,(1),null);
var vec__24584 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24584,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24584,(1),null);
var vec__24587 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24587,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24587,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24587,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24587,(3),null);
...
var vec__24593 = result;
var munged_ns = cljs.core.nth.call(null,vec__24593,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24593,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24593,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24593,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24593,(4),null);
var arity = cljs.core.nth.call(null,vec__24593,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__24597 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__24597,(0),null);
var args = cljs.core.nth.call(null,vec__24597,(1),null);
var vec__24600 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24600,(0),null);
var name = cljs.core.nth.call(null,vec__24600,(1),null);
...
var G__24603 = (arity + (1));
var G__24604 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24605){
var vec__24606 = p__24605;
var arity = cljs.core.nth.call(null,vec__24606,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24606,(1),null);
...
return cljs.core.get.call(null,arities,p1__24609_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24610_SHARP_);
...
var args__11094__auto__ = [];
var len__11087__auto___24617 = arguments.length;
var i__11088__auto___24618 = (0);
while(true){
if((i__11088__auto___24618 < len__11087__auto___24617)){
args__11094__auto__.push((arguments[i__11088__auto___24618]));

var G__24619 = (i__11088__auto___24618 + (1));
i__11088__auto___24618 = G__24619;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24613){
var vec__24614 = p__24613;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24614,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24611){
var G__24612 = cljs.core.first.call(null,seq24611);
var seq24611__$1 = cljs.core.next.call(null,seq24611);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__24612,seq24611__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24622__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24622__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24622__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24622__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24623 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24623,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24623,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24623,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24623,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24623,(4),null);
var arity = cljs.core.nth.call(null,vec__24623,(5),null);
...
var o__12357__auto__ = f;
return (o__12357__auto__["getBasis"]).call(o__12357__auto__);
});
/**
...
}catch (e24627){var _e__12364__auto__ = e24627;
...
var G__24628 = (obj[cljs.core.first.call(null,path)]);
var G__24629 = cljs.core.rest.call(null,path);
obj = G__24628;
path = G__24629;
continue;
} else {
...
return (function (accum,p__24630){
var vec__24631 = p__24630;
var bit = cljs.core.nth.call(null,vec__24631,(0),null);
var protocol = cljs.core.nth.call(null,vec__24631,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24634){
var vec__24635 = p__24634;
var ns = cljs.core.nth.call(null,vec__24635,(0),null);
var name = cljs.core.nth.call(null,vec__24635,(1),null);
var selector = cljs.core.nth.call(null,vec__24635,(2),null);
...
return (function (p__24639){
var vec__24640 = p__24639;
var munged_name = cljs.core.nth.call(null,vec__24640,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24640,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24640,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24638_SHARP_){
return (obj[cljs.core.first.call(null,p1__24638_SHARP_)]);
});})(name,sorted_matches,vec__24640,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1504914138131
