...
var o79102 = temp__6736__auto__;
var temp__6736__auto____$1 = (o79102["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o79103 = temp__6736__auto____$1;
return (o79103["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__73233__auto__ = f;
return (o__73233__auto__["toString"]).call(o__73233__auto__);
} else {
return "";
}
}catch (e79104){var _ = e79104;
return "";
}});
...
try{var o__73233__auto___79106 = t;
(o__73233__auto___79106["cljs$lang$ctorPrWriter"]).call(o__73233__auto___79106,t,writer);
}catch (e79105){var __79107 = e79105;
}
...
var char_code = (function (){var o__73233__auto__ = (new String(char$));
return (o__73233__auto__["charCodeAt"]).call(o__73233__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__73233__auto__ = String;
return (o__73233__auto__["fromCharCode"]).call(o__73233__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__79108 = num_code;
switch (G__79108) {
case (1):
return (185);
...
var o__73233__auto__ = String;
return (o__73233__auto__["fromCharCode"]).call(o__73233__auto__,superscript_code);
});
/**
...
}catch (e79110){var _e__73240__auto__ = e79110;
return false;
}})())){
...
var vec__79111 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__79111,(0),null);
...
var or__64417__auto__ = (function (){var temp__6736__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__6736__auto__)){
...
if(cljs.core.truth_(temp__6736__auto__)){
var o79114 = temp__6736__auto__;
var temp__6736__auto____$1 = (o79114["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o79115 = temp__6736__auto____$1;
return (o79115["nameToPath"]);
} else {
return null;
}
} else {
...
var len__65694__auto___79122 = arguments.length;
var i__65695__auto___79123 = (0);
while(true){
if((i__65695__auto___79123 < len__65694__auto___79122)){
args__65701__auto__.push((arguments[i__65695__auto___79123]));

var G__79124 = (i__65695__auto___79123 + (1));
i__65695__auto___79123 = G__79124;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__65702__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__79118){
var vec__79119 = p__79118;
var ns_detector = cljs.core.nth.call(null,vec__79119,(0),null);
var effective_detector = (function (){var or__64417__auto__ = ns_detector;
if(cljs.core.truth_(or__64417__auto__)){
return or__64417__auto__;
} else {
...
var G__79125 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__79126 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__79125;
remaining_tokens = G__79126;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq79116){
var G__79117 = cljs.core.first.call(null,seq79116);
var seq79116__$1 = cljs.core.next.call(null,seq79116);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__79117,seq79116__$1);
});
...
var vec__79130 = cljs.core.split_with.call(null,(function (p1__79129_SHARP_){
return cljs.core.not_EQ_.call(null,p1__79129_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__79130,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__79130,(1),null);
...
var vec__79133 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__79133,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__79133,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__79136 = cljs.core.rest.call(null,remaining_tokens);
var G__79137 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__79136;
name_tokens = G__79137;
continue;
} else {
...
var vec__79140 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__79140,(0),null);
var arity = cljs.core.nth.call(null,vec__79140,(1),null);
var vec__79143 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__79143,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__79143,(1),null);
var vec__79146 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__79146,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__79146,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__79146,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__79146,(3),null);
...
var vec__79152 = result;
var munged_ns = cljs.core.nth.call(null,vec__79152,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__79152,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__79152,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__79152,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__79152,(4),null);
var arity = cljs.core.nth.call(null,vec__79152,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__79156 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__79156,(0),null);
var args = cljs.core.nth.call(null,vec__79156,(1),null);
var vec__79159 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__79159,(0),null);
var name = cljs.core.nth.call(null,vec__79159,(1),null);
...
var G__79162 = (arity + (1));
var G__79163 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__79164){
var vec__79165 = p__79164;
var arity = cljs.core.nth.call(null,vec__79165,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__79165,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__64417__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__64417__auto__)){
return or__64417__auto__;
} else {
...
return (function (p1__79168_SHARP_){
return cljs.core.get.call(null,arities,p1__79168_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__79169_SHARP_){
return cljs.core.drop.call(null,(2),p1__79169_SHARP_);
...
var args__65701__auto__ = [];
var len__65694__auto___79176 = arguments.length;
var i__65695__auto___79177 = (0);
while(true){
if((i__65695__auto___79177 < len__65694__auto___79176)){
args__65701__auto__.push((arguments[i__65695__auto___79177]));

var G__79178 = (i__65695__auto___79177 + (1));
i__65695__auto___79177 = G__79178;
continue;
} else {
}
break;
...
var argseq__65702__auto__ = ((((1) < args__65701__auto__.length))?(new cljs.core.IndexedSeq(args__65701__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__65702__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__79172){
var vec__79173 = p__79172;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__79173,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq79170){
var G__79171 = cljs.core.first.call(null,seq79170);
var seq79170__$1 = cljs.core.next.call(null,seq79170);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__79171,seq79170__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__64417__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__64417__auto__)){
return or__64417__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__64405__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__64417__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__64417__auto__)){
return or__64417__auto__;
} else {
...
var map__79181 = options;
var map__79181__$1 = ((((!((map__79181 == null)))?((((map__79181.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__79181.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__79181):map__79181);
var include_ns_QMARK_ = cljs.core.get.call(null,map__79181__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__79181__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__79181__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__79181__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__79182 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__79182,(0),null);
var fn_name = cljs.core.nth.call(null,vec__79182,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__79182,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__79182,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__79182,(4),null);
var arity = cljs.core.nth.call(null,vec__79182,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__64405__auto__ = protocol_ns;
if(cljs.core.truth_(and__64405__auto__)){
return cljs.core.not.call(null,(function (){var and__64405__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__64417__auto__ = protocol_part;
if(cljs.core.truth_(or__64417__auto__)){
return or__64417__auto__;
} else {
return fn_part;
...
var o__73233__auto__ = f;
return (o__73233__auto__["getBasis"]).call(o__73233__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__64405__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__64405__auto__)){
...
}catch (e79186){var _e__73240__auto__ = e79186;
...
var G__79187 = (obj[cljs.core.first.call(null,path)]);
var G__79188 = cljs.core.rest.call(null,path);
obj = G__79187;
path = G__79188;
continue;
} else {
...
var partition_bits = (function (){var or__64417__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__64417__auto__)){
return or__64417__auto__;
} else {
return (0);
...
return (function (accum,p__79189){
var vec__79190 = p__79189;
var bit = cljs.core.nth.call(null,vec__79190,(0),null);
var protocol = cljs.core.nth.call(null,vec__79190,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__79193){
var vec__79194 = p__79193;
var ns = cljs.core.nth.call(null,vec__79194,(0),null);
var name = cljs.core.nth.call(null,vec__79194,(1),null);
var selector = cljs.core.nth.call(null,vec__79194,(2),null);
...
return (function (p__79198){
var vec__79199 = p__79198;
var munged_name = cljs.core.nth.call(null,vec__79199,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__79199,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__79199,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__79197_SHARP_){
return (obj[cljs.core.first.call(null,p1__79197_SHARP_)]);
});})(name,sorted_matches,vec__79199,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1506558359115
