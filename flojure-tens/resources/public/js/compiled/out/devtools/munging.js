...
var o24550 = temp__6736__auto__;
var temp__6736__auto____$1 = (o24550["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o24551 = temp__6736__auto____$1;
return (o24551["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__18419__auto___24554 = t;
(o__18419__auto___24554["cljs$lang$ctorPrWriter"]).call(o__18419__auto___24554,t,writer);
}catch (e24553){var __24555 = e24553;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24556 = num_code;
switch (G__24556) {
case (1):
return (185);
...
}catch (e24558){var _e__18426__auto__ = e24558;
return false;
}})())){
...
var vec__24559 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24559,(0),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var o24562 = temp__6736__auto__;
var temp__6736__auto____$1 = (o24562["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o24563 = temp__6736__auto____$1;
return (o24563["nameToPath"]);
} else {
return null;
}
} else {
...
var len__11087__auto___24570 = arguments.length;
var i__11088__auto___24571 = (0);
while(true){
if((i__11088__auto___24571 < len__11087__auto___24570)){
args__11094__auto__.push((arguments[i__11088__auto___24571]));

var G__24572 = (i__11088__auto___24571 + (1));
i__11088__auto___24571 = G__24572;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24566){
var vec__24567 = p__24566;
var ns_detector = cljs.core.nth.call(null,vec__24567,(0),null);
...
var G__24573 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24574 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24573;
remaining_tokens = G__24574;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24564){
var G__24565 = cljs.core.first.call(null,seq24564);
var seq24564__$1 = cljs.core.next.call(null,seq24564);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__24565,seq24564__$1);
});
...
var vec__24578 = cljs.core.split_with.call(null,(function (p1__24577_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24577_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24578,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24578,(1),null);
...
var vec__24581 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24581,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24581,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24584 = cljs.core.rest.call(null,remaining_tokens);
var G__24585 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24584;
name_tokens = G__24585;
continue;
} else {
...
var vec__24588 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24588,(0),null);
var arity = cljs.core.nth.call(null,vec__24588,(1),null);
var vec__24591 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24591,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24591,(1),null);
var vec__24594 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24594,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24594,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24594,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24594,(3),null);
...
var vec__24600 = result;
var munged_ns = cljs.core.nth.call(null,vec__24600,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24600,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24600,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24600,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24600,(4),null);
var arity = cljs.core.nth.call(null,vec__24600,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__24604 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__24604,(0),null);
var args = cljs.core.nth.call(null,vec__24604,(1),null);
var vec__24607 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24607,(0),null);
var name = cljs.core.nth.call(null,vec__24607,(1),null);
...
var G__24610 = (arity + (1));
var G__24611 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24612){
var vec__24613 = p__24612;
var arity = cljs.core.nth.call(null,vec__24613,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24613,(1),null);
...
return cljs.core.get.call(null,arities,p1__24616_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24617_SHARP_);
...
var args__11094__auto__ = [];
var len__11087__auto___24624 = arguments.length;
var i__11088__auto___24625 = (0);
while(true){
if((i__11088__auto___24625 < len__11087__auto___24624)){
args__11094__auto__.push((arguments[i__11088__auto___24625]));

var G__24626 = (i__11088__auto___24625 + (1));
i__11088__auto___24625 = G__24626;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24620){
var vec__24621 = p__24620;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24621,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24618){
var G__24619 = cljs.core.first.call(null,seq24618);
var seq24618__$1 = cljs.core.next.call(null,seq24618);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__24619,seq24618__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24629__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24629__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24629__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24629__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24630 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24630,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24630,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24630,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24630,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24630,(4),null);
...
}catch (e24634){var _e__18426__auto__ = e24634;
...
var G__24635 = (obj[cljs.core.first.call(null,path)]);
var G__24636 = cljs.core.rest.call(null,path);
obj = G__24635;
path = G__24636;
continue;
} else {
...
return (function (accum,p__24637){
var vec__24638 = p__24637;
var bit = cljs.core.nth.call(null,vec__24638,(0),null);
var protocol = cljs.core.nth.call(null,vec__24638,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24641){
var vec__24642 = p__24641;
var ns = cljs.core.nth.call(null,vec__24642,(0),null);
var name = cljs.core.nth.call(null,vec__24642,(1),null);
var selector = cljs.core.nth.call(null,vec__24642,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24647,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24647,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24647,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24645_SHARP_){
return (obj[cljs.core.first.call(null,p1__24645_SHARP_)]);
});})(name,sorted_matches,vec__24647,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1505834888964
