...
var o14149 = temp__6736__auto__;
var temp__6736__auto____$1 = (o14149["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o14150 = temp__6736__auto____$1;
return (o14150["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__13261__auto___14153 = t;
(o__13261__auto___14153["cljs$lang$ctorPrWriter"]).call(o__13261__auto___14153,t,writer);
}catch (e14152){var __14154 = e14152;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14155 = num_code;
switch (G__14155) {
case (1):
return (185);
...
}catch (e14157){var _e__13268__auto__ = e14157;
return false;
}})())){
...
var vec__14158 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__14158,(0),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var o14161 = temp__6736__auto__;
var temp__6736__auto____$1 = (o14161["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o14162 = temp__6736__auto____$1;
return (o14162["nameToPath"]);
} else {
return null;
}
} else {
...
var len__11087__auto___14169 = arguments.length;
var i__11088__auto___14170 = (0);
while(true){
if((i__11088__auto___14170 < len__11087__auto___14169)){
args__11094__auto__.push((arguments[i__11088__auto___14170]));

var G__14171 = (i__11088__auto___14170 + (1));
i__11088__auto___14170 = G__14171;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14165){
var vec__14166 = p__14165;
var ns_detector = cljs.core.nth.call(null,vec__14166,(0),null);
...
var G__14172 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__14173 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__14172;
remaining_tokens = G__14173;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14163){
var G__14164 = cljs.core.first.call(null,seq14163);
var seq14163__$1 = cljs.core.next.call(null,seq14163);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__14164,seq14163__$1);
});
...
var vec__14177 = cljs.core.split_with.call(null,(function (p1__14176_SHARP_){
return cljs.core.not_EQ_.call(null,p1__14176_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__14177,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__14177,(1),null);
...
var vec__14180 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__14180,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__14180,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__14183 = cljs.core.rest.call(null,remaining_tokens);
var G__14184 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__14183;
name_tokens = G__14184;
continue;
} else {
...
var vec__14187 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__14187,(0),null);
var arity = cljs.core.nth.call(null,vec__14187,(1),null);
var vec__14190 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__14190,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__14190,(1),null);
var vec__14193 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__14193,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__14193,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__14193,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__14193,(3),null);
...
var vec__14199 = result;
var munged_ns = cljs.core.nth.call(null,vec__14199,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__14199,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__14199,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__14199,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__14199,(4),null);
var arity = cljs.core.nth.call(null,vec__14199,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__14203 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__14203,(0),null);
var args = cljs.core.nth.call(null,vec__14203,(1),null);
var vec__14206 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__14206,(0),null);
var name = cljs.core.nth.call(null,vec__14206,(1),null);
...
var G__14209 = (arity + (1));
var G__14210 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14211){
var vec__14212 = p__14211;
var arity = cljs.core.nth.call(null,vec__14212,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__14212,(1),null);
...
return cljs.core.get.call(null,arities,p1__14215_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__14216_SHARP_);
...
var args__11094__auto__ = [];
var len__11087__auto___14223 = arguments.length;
var i__11088__auto___14224 = (0);
while(true){
if((i__11088__auto___14224 < len__11087__auto___14223)){
args__11094__auto__.push((arguments[i__11088__auto___14224]));

var G__14225 = (i__11088__auto___14224 + (1));
i__11088__auto___14224 = G__14225;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14219){
var vec__14220 = p__14219;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__14220,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14217){
var G__14218 = cljs.core.first.call(null,seq14217);
var seq14217__$1 = cljs.core.next.call(null,seq14217);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__14218,seq14217__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__14228__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__14228__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__14228__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__14228__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__14229 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__14229,(0),null);
var fn_name = cljs.core.nth.call(null,vec__14229,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__14229,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__14229,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__14229,(4),null);
var arity = cljs.core.nth.call(null,vec__14229,(5),null);
...
}catch (e14233){var _e__13268__auto__ = e14233;
...
var G__14234 = (obj[cljs.core.first.call(null,path)]);
var G__14235 = cljs.core.rest.call(null,path);
obj = G__14234;
path = G__14235;
continue;
} else {
...
return (function (accum,p__14236){
var vec__14237 = p__14236;
var bit = cljs.core.nth.call(null,vec__14237,(0),null);
var protocol = cljs.core.nth.call(null,vec__14237,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14240){
var vec__14241 = p__14240;
var ns = cljs.core.nth.call(null,vec__14241,(0),null);
var name = cljs.core.nth.call(null,vec__14241,(1),null);
var selector = cljs.core.nth.call(null,vec__14241,(2),null);
...
return (function (p__14245){
var vec__14246 = p__14245;
var munged_name = cljs.core.nth.call(null,vec__14246,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__14246,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__14246,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__14244_SHARP_){
return (obj[cljs.core.first.call(null,p1__14244_SHARP_)]);
});})(name,sorted_matches,vec__14246,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1505782675360
