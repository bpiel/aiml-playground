...
var o72507 = temp__6736__auto__;
var temp__6736__auto____$1 = (o72507["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o72508 = temp__6736__auto____$1;
return (o72508["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__66952__auto__ = f;
return (o__66952__auto__["toString"]).call(o__66952__auto__);
} else {
return "";
}
}catch (e72509){var _ = e72509;
return "";
}});
...
try{var o__66952__auto___72511 = t;
(o__66952__auto___72511["cljs$lang$ctorPrWriter"]).call(o__66952__auto___72511,t,writer);
}catch (e72510){var __72512 = e72510;
}
...
var char_code = (function (){var o__66952__auto__ = (new String(char$));
return (o__66952__auto__["charCodeAt"]).call(o__66952__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__66952__auto__ = String;
return (o__66952__auto__["fromCharCode"]).call(o__66952__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__72513 = num_code;
switch (G__72513) {
case (1):
return (185);
...
var o__66952__auto__ = String;
return (o__66952__auto__["fromCharCode"]).call(o__66952__auto__,superscript_code);
});
/**
...
}catch (e72515){var _e__66959__auto__ = e72515;
return false;
}})())){
...
var vec__72516 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__72516,(0),null);
...
var or__58135__auto__ = (function (){var temp__6736__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__6736__auto__)){
...
if(cljs.core.truth_(temp__6736__auto__)){
var o72519 = temp__6736__auto__;
var temp__6736__auto____$1 = (o72519["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o72520 = temp__6736__auto____$1;
return (o72520["nameToPath"]);
} else {
return null;
}
} else {
...
var len__59412__auto___72527 = arguments.length;
var i__59413__auto___72528 = (0);
while(true){
if((i__59413__auto___72528 < len__59412__auto___72527)){
args__59419__auto__.push((arguments[i__59413__auto___72528]));

var G__72529 = (i__59413__auto___72528 + (1));
i__59413__auto___72528 = G__72529;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__59420__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__72523){
var vec__72524 = p__72523;
var ns_detector = cljs.core.nth.call(null,vec__72524,(0),null);
var effective_detector = (function (){var or__58135__auto__ = ns_detector;
if(cljs.core.truth_(or__58135__auto__)){
return or__58135__auto__;
} else {
...
var G__72530 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__72531 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__72530;
remaining_tokens = G__72531;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq72521){
var G__72522 = cljs.core.first.call(null,seq72521);
var seq72521__$1 = cljs.core.next.call(null,seq72521);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__72522,seq72521__$1);
});
...
var vec__72535 = cljs.core.split_with.call(null,(function (p1__72534_SHARP_){
return cljs.core.not_EQ_.call(null,p1__72534_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__72535,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__72535,(1),null);
...
var vec__72538 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__72538,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__72538,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__72541 = cljs.core.rest.call(null,remaining_tokens);
var G__72542 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__72541;
name_tokens = G__72542;
continue;
} else {
...
var vec__72545 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__72545,(0),null);
var arity = cljs.core.nth.call(null,vec__72545,(1),null);
var vec__72548 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__72548,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__72548,(1),null);
var vec__72551 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__72551,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__72551,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__72551,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__72551,(3),null);
...
var vec__72557 = result;
var munged_ns = cljs.core.nth.call(null,vec__72557,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__72557,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__72557,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__72557,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__72557,(4),null);
var arity = cljs.core.nth.call(null,vec__72557,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__72561 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__72561,(0),null);
var args = cljs.core.nth.call(null,vec__72561,(1),null);
var vec__72564 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__72564,(0),null);
var name = cljs.core.nth.call(null,vec__72564,(1),null);
...
var G__72567 = (arity + (1));
var G__72568 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__72569){
var vec__72570 = p__72569;
var arity = cljs.core.nth.call(null,vec__72570,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__72570,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__58135__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__58135__auto__)){
return or__58135__auto__;
} else {
...
return (function (p1__72573_SHARP_){
return cljs.core.get.call(null,arities,p1__72573_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__72574_SHARP_){
return cljs.core.drop.call(null,(2),p1__72574_SHARP_);
...
var args__59419__auto__ = [];
var len__59412__auto___72581 = arguments.length;
var i__59413__auto___72582 = (0);
while(true){
if((i__59413__auto___72582 < len__59412__auto___72581)){
args__59419__auto__.push((arguments[i__59413__auto___72582]));

var G__72583 = (i__59413__auto___72582 + (1));
i__59413__auto___72582 = G__72583;
continue;
} else {
}
break;
...
var argseq__59420__auto__ = ((((1) < args__59419__auto__.length))?(new cljs.core.IndexedSeq(args__59419__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__59420__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__72577){
var vec__72578 = p__72577;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__72578,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq72575){
var G__72576 = cljs.core.first.call(null,seq72575);
var seq72575__$1 = cljs.core.next.call(null,seq72575);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__72576,seq72575__$1);
});
...
var G__72584 = arg;
var G__72584__$1 = (((G__72584 instanceof cljs.core.Keyword))?G__72584.fqn:null);
switch (G__72584__$1) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__58135__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__58135__auto__)){
return or__58135__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__58123__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__58135__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__58135__auto__)){
return or__58135__auto__;
} else {
...
var map__72586 = options;
var map__72586__$1 = ((((!((map__72586 == null)))?((((map__72586.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__72586.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__72586):map__72586);
var include_ns_QMARK_ = cljs.core.get.call(null,map__72586__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__72586__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__72586__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__72586__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__72587 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__72587,(0),null);
var fn_name = cljs.core.nth.call(null,vec__72587,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__72587,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__72587,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__72587,(4),null);
var arity = cljs.core.nth.call(null,vec__72587,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__58123__auto__ = protocol_ns;
if(cljs.core.truth_(and__58123__auto__)){
return cljs.core.not.call(null,(function (){var and__58123__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__58135__auto__ = protocol_part;
if(cljs.core.truth_(or__58135__auto__)){
return or__58135__auto__;
} else {
return fn_part;
...
var o__66952__auto__ = f;
return (o__66952__auto__["getBasis"]).call(o__66952__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__58123__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__58123__auto__)){
...
}catch (e72591){var _e__66959__auto__ = e72591;
...
var G__72592 = (obj[cljs.core.first.call(null,path)]);
var G__72593 = cljs.core.rest.call(null,path);
obj = G__72592;
path = G__72593;
continue;
} else {
...
var partition_bits = (function (){var or__58135__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__58135__auto__)){
return or__58135__auto__;
} else {
return (0);
...
return (function (accum,p__72594){
var vec__72595 = p__72594;
var bit = cljs.core.nth.call(null,vec__72595,(0),null);
var protocol = cljs.core.nth.call(null,vec__72595,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__72598){
var vec__72599 = p__72598;
var ns = cljs.core.nth.call(null,vec__72599,(0),null);
var name = cljs.core.nth.call(null,vec__72599,(1),null);
var selector = cljs.core.nth.call(null,vec__72599,(2),null);
...
return (function (p__72603){
var vec__72604 = p__72603;
var munged_name = cljs.core.nth.call(null,vec__72604,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__72604,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__72604,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__72602_SHARP_){
return (obj[cljs.core.first.call(null,p1__72602_SHARP_)]);
});})(name,sorted_matches,vec__72604,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1506641520382
