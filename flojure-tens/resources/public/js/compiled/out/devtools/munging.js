...
var o24544 = temp__6736__auto__;
var temp__6736__auto____$1 = (o24544["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o24545 = temp__6736__auto____$1;
return (o24545["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__12357__auto___24548 = t;
(o__12357__auto___24548["cljs$lang$ctorPrWriter"]).call(o__12357__auto___24548,t,writer);
}catch (e24547){var __24549 = e24547;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24550 = num_code;
switch (G__24550) {
case (1):
return (185);
...
}catch (e24552){var _e__12364__auto__ = e24552;
return false;
}})())){
...
var vec__24553 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24553,(0),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var o24556 = temp__6736__auto__;
var temp__6736__auto____$1 = (o24556["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o24557 = temp__6736__auto____$1;
return (o24557["nameToPath"]);
} else {
return null;
}
} else {
...
var len__11087__auto___24564 = arguments.length;
var i__11088__auto___24565 = (0);
while(true){
if((i__11088__auto___24565 < len__11087__auto___24564)){
args__11094__auto__.push((arguments[i__11088__auto___24565]));

var G__24566 = (i__11088__auto___24565 + (1));
i__11088__auto___24565 = G__24566;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24560){
var vec__24561 = p__24560;
var ns_detector = cljs.core.nth.call(null,vec__24561,(0),null);
...
var G__24567 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24568 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24567;
remaining_tokens = G__24568;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24558){
var G__24559 = cljs.core.first.call(null,seq24558);
var seq24558__$1 = cljs.core.next.call(null,seq24558);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__24559,seq24558__$1);
});
...
var vec__24572 = cljs.core.split_with.call(null,(function (p1__24571_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24571_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24572,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24572,(1),null);
...
var vec__24575 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24575,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24575,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24578 = cljs.core.rest.call(null,remaining_tokens);
var G__24579 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24578;
name_tokens = G__24579;
continue;
} else {
...
var vec__24582 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24582,(0),null);
var arity = cljs.core.nth.call(null,vec__24582,(1),null);
var vec__24585 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24585,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24585,(1),null);
var vec__24588 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24588,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24588,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24588,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24588,(3),null);
...
var vec__24594 = result;
var munged_ns = cljs.core.nth.call(null,vec__24594,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24594,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24594,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24594,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24594,(4),null);
var arity = cljs.core.nth.call(null,vec__24594,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__24598 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__24598,(0),null);
var args = cljs.core.nth.call(null,vec__24598,(1),null);
var vec__24601 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24601,(0),null);
var name = cljs.core.nth.call(null,vec__24601,(1),null);
...
var G__24604 = (arity + (1));
var G__24605 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24606){
var vec__24607 = p__24606;
var arity = cljs.core.nth.call(null,vec__24607,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24607,(1),null);
...
return cljs.core.get.call(null,arities,p1__24610_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24611_SHARP_);
...
var args__11094__auto__ = [];
var len__11087__auto___24618 = arguments.length;
var i__11088__auto___24619 = (0);
while(true){
if((i__11088__auto___24619 < len__11087__auto___24618)){
args__11094__auto__.push((arguments[i__11088__auto___24619]));

var G__24620 = (i__11088__auto___24619 + (1));
i__11088__auto___24619 = G__24620;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24614){
var vec__24615 = p__24614;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24615,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24612){
var G__24613 = cljs.core.first.call(null,seq24612);
var seq24612__$1 = cljs.core.next.call(null,seq24612);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__24613,seq24612__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24623__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24623__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24623__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24623__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24624 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24624,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24624,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24624,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24624,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24624,(4),null);
var arity = cljs.core.nth.call(null,vec__24624,(5),null);
...
}catch (e24628){var _e__12364__auto__ = e24628;
...
var G__24629 = (obj[cljs.core.first.call(null,path)]);
var G__24630 = cljs.core.rest.call(null,path);
obj = G__24629;
path = G__24630;
continue;
} else {
...
return (function (accum,p__24631){
var vec__24632 = p__24631;
var bit = cljs.core.nth.call(null,vec__24632,(0),null);
var protocol = cljs.core.nth.call(null,vec__24632,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24635){
var vec__24636 = p__24635;
var ns = cljs.core.nth.call(null,vec__24636,(0),null);
var name = cljs.core.nth.call(null,vec__24636,(1),null);
var selector = cljs.core.nth.call(null,vec__24636,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24641,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24641,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24641,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24639_SHARP_){
return (obj[cljs.core.first.call(null,p1__24639_SHARP_)]);
});})(name,sorted_matches,vec__24641,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1505319635130
