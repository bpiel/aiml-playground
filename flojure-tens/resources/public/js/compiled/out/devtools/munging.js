...
var o25761 = temp__6736__auto__;
var temp__6736__auto____$1 = (o25761["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o25762 = temp__6736__auto____$1;
return (o25762["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__13261__auto___25765 = t;
(o__13261__auto___25765["cljs$lang$ctorPrWriter"]).call(o__13261__auto___25765,t,writer);
}catch (e25764){var __25766 = e25764;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25767 = num_code;
switch (G__25767) {
case (1):
return (185);
...
}catch (e25769){var _e__13268__auto__ = e25769;
return false;
}})())){
...
var vec__25770 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25770,(0),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var o25773 = temp__6736__auto__;
var temp__6736__auto____$1 = (o25773["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o25774 = temp__6736__auto____$1;
return (o25774["nameToPath"]);
} else {
return null;
}
} else {
...
var len__11087__auto___25781 = arguments.length;
var i__11088__auto___25782 = (0);
while(true){
if((i__11088__auto___25782 < len__11087__auto___25781)){
args__11094__auto__.push((arguments[i__11088__auto___25782]));

var G__25783 = (i__11088__auto___25782 + (1));
i__11088__auto___25782 = G__25783;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25777){
var vec__25778 = p__25777;
var ns_detector = cljs.core.nth.call(null,vec__25778,(0),null);
...
var G__25784 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25785 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25784;
remaining_tokens = G__25785;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25775){
var G__25776 = cljs.core.first.call(null,seq25775);
var seq25775__$1 = cljs.core.next.call(null,seq25775);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__25776,seq25775__$1);
});
...
var vec__25789 = cljs.core.split_with.call(null,(function (p1__25788_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25788_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25789,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25789,(1),null);
...
var vec__25792 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25792,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25792,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25795 = cljs.core.rest.call(null,remaining_tokens);
var G__25796 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25795;
name_tokens = G__25796;
continue;
} else {
...
var vec__25799 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25799,(0),null);
var arity = cljs.core.nth.call(null,vec__25799,(1),null);
var vec__25802 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25802,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25802,(1),null);
var vec__25805 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25805,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25805,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25805,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25805,(3),null);
...
var vec__25811 = result;
var munged_ns = cljs.core.nth.call(null,vec__25811,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25811,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25811,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25811,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25811,(4),null);
var arity = cljs.core.nth.call(null,vec__25811,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__25815 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__25815,(0),null);
var args = cljs.core.nth.call(null,vec__25815,(1),null);
var vec__25818 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25818,(0),null);
var name = cljs.core.nth.call(null,vec__25818,(1),null);
...
var G__25821 = (arity + (1));
var G__25822 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25823){
var vec__25824 = p__25823;
var arity = cljs.core.nth.call(null,vec__25824,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25824,(1),null);
...
return cljs.core.get.call(null,arities,p1__25827_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25828_SHARP_);
...
var args__11094__auto__ = [];
var len__11087__auto___25835 = arguments.length;
var i__11088__auto___25836 = (0);
while(true){
if((i__11088__auto___25836 < len__11087__auto___25835)){
args__11094__auto__.push((arguments[i__11088__auto___25836]));

var G__25837 = (i__11088__auto___25836 + (1));
i__11088__auto___25836 = G__25837;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25831){
var vec__25832 = p__25831;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25832,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25829){
var G__25830 = cljs.core.first.call(null,seq25829);
var seq25829__$1 = cljs.core.next.call(null,seq25829);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__25830,seq25829__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25840__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25840__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25840__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25840__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25841 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25841,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25841,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25841,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25841,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25841,(4),null);
var arity = cljs.core.nth.call(null,vec__25841,(5),null);
...
}catch (e25845){var _e__13268__auto__ = e25845;
...
var G__25846 = (obj[cljs.core.first.call(null,path)]);
var G__25847 = cljs.core.rest.call(null,path);
obj = G__25846;
path = G__25847;
continue;
} else {
...
return (function (accum,p__25848){
var vec__25849 = p__25848;
var bit = cljs.core.nth.call(null,vec__25849,(0),null);
var protocol = cljs.core.nth.call(null,vec__25849,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25852){
var vec__25853 = p__25852;
var ns = cljs.core.nth.call(null,vec__25853,(0),null);
var name = cljs.core.nth.call(null,vec__25853,(1),null);
var selector = cljs.core.nth.call(null,vec__25853,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__25858,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25858,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25858,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25856_SHARP_){
return (obj[cljs.core.first.call(null,p1__25856_SHARP_)]);
});})(name,sorted_matches,vec__25858,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1504894099010
