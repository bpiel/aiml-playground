...
var o25800 = temp__6736__auto__;
var temp__6736__auto____$1 = (o25800["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o25801 = temp__6736__auto____$1;
return (o25801["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19323__auto__ = f;
return (o__19323__auto__["toString"]).call(o__19323__auto__);
} else {
return "";
}
}catch (e25802){var _ = e25802;
return "";
}});
...
try{var o__19323__auto___25804 = t;
(o__19323__auto___25804["cljs$lang$ctorPrWriter"]).call(o__19323__auto___25804,t,writer);
}catch (e25803){var __25805 = e25803;
}
...
var char_code = (function (){var o__19323__auto__ = (new String(char$));
return (o__19323__auto__["charCodeAt"]).call(o__19323__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19323__auto__ = String;
return (o__19323__auto__["fromCharCode"]).call(o__19323__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25806 = num_code;
switch (G__25806) {
case (1):
return (185);
...
var o__19323__auto__ = String;
return (o__19323__auto__["fromCharCode"]).call(o__19323__auto__,superscript_code);
});
/**
...
}catch (e25808){var _e__19330__auto__ = e25808;
return false;
}})())){
...
var vec__25809 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25809,(0),null);
...
var or__9810__auto__ = (function (){var temp__6736__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__6736__auto__)){
...
if(cljs.core.truth_(temp__6736__auto__)){
var o25812 = temp__6736__auto__;
var temp__6736__auto____$1 = (o25812["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o25813 = temp__6736__auto____$1;
return (o25813["nameToPath"]);
} else {
return null;
}
} else {
...
var len__11087__auto___25820 = arguments.length;
var i__11088__auto___25821 = (0);
while(true){
if((i__11088__auto___25821 < len__11087__auto___25820)){
args__11094__auto__.push((arguments[i__11088__auto___25821]));

var G__25822 = (i__11088__auto___25821 + (1));
i__11088__auto___25821 = G__25822;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__11095__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25816){
var vec__25817 = p__25816;
var ns_detector = cljs.core.nth.call(null,vec__25817,(0),null);
var effective_detector = (function (){var or__9810__auto__ = ns_detector;
if(cljs.core.truth_(or__9810__auto__)){
return or__9810__auto__;
} else {
...
var G__25823 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25824 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25823;
remaining_tokens = G__25824;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25814){
var G__25815 = cljs.core.first.call(null,seq25814);
var seq25814__$1 = cljs.core.next.call(null,seq25814);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__25815,seq25814__$1);
});
...
var vec__25828 = cljs.core.split_with.call(null,(function (p1__25827_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25827_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25828,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25828,(1),null);
...
var vec__25831 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25831,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25831,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25834 = cljs.core.rest.call(null,remaining_tokens);
var G__25835 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25834;
name_tokens = G__25835;
continue;
} else {
...
var vec__25838 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25838,(0),null);
var arity = cljs.core.nth.call(null,vec__25838,(1),null);
var vec__25841 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25841,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25841,(1),null);
var vec__25844 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25844,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25844,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25844,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25844,(3),null);
...
var vec__25850 = result;
var munged_ns = cljs.core.nth.call(null,vec__25850,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25850,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25850,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25850,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25850,(4),null);
var arity = cljs.core.nth.call(null,vec__25850,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__25854 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__25854,(0),null);
var args = cljs.core.nth.call(null,vec__25854,(1),null);
var vec__25857 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25857,(0),null);
var name = cljs.core.nth.call(null,vec__25857,(1),null);
...
var G__25860 = (arity + (1));
var G__25861 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25862){
var vec__25863 = p__25862;
var arity = cljs.core.nth.call(null,vec__25863,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25863,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__9810__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__9810__auto__)){
return or__9810__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__25866_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25867_SHARP_);
...
var args__11094__auto__ = [];
var len__11087__auto___25874 = arguments.length;
var i__11088__auto___25875 = (0);
while(true){
if((i__11088__auto___25875 < len__11087__auto___25874)){
args__11094__auto__.push((arguments[i__11088__auto___25875]));

var G__25876 = (i__11088__auto___25875 + (1));
i__11088__auto___25875 = G__25876;
continue;
} else {
}
break;
...
var argseq__11095__auto__ = ((((1) < args__11094__auto__.length))?(new cljs.core.IndexedSeq(args__11094__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__11095__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25870){
var vec__25871 = p__25870;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25871,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25868){
var G__25869 = cljs.core.first.call(null,seq25868);
var seq25868__$1 = cljs.core.next.call(null,seq25868);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__25869,seq25868__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__9810__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__9810__auto__)){
return or__9810__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__9798__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__9810__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__9810__auto__)){
return or__9810__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25879__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25879__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25879__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25879__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25880 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25880,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25880,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25880,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25880,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25880,(4),null);
var arity = cljs.core.nth.call(null,vec__25880,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__9798__auto__ = protocol_ns;
if(cljs.core.truth_(and__9798__auto__)){
return cljs.core.not.call(null,(function (){var and__9798__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__9810__auto__ = protocol_part;
if(cljs.core.truth_(or__9810__auto__)){
return or__9810__auto__;
} else {
return fn_part;
...
var o__19323__auto__ = f;
return (o__19323__auto__["getBasis"]).call(o__19323__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__9798__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__9798__auto__)){
...
}catch (e25884){var _e__19330__auto__ = e25884;
...
var G__25885 = (obj[cljs.core.first.call(null,path)]);
var G__25886 = cljs.core.rest.call(null,path);
obj = G__25885;
path = G__25886;
continue;
} else {
...
var partition_bits = (function (){var or__9810__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__9810__auto__)){
return or__9810__auto__;
} else {
return (0);
...
return (function (accum,p__25887){
var vec__25888 = p__25887;
var bit = cljs.core.nth.call(null,vec__25888,(0),null);
var protocol = cljs.core.nth.call(null,vec__25888,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25891){
var vec__25892 = p__25891;
var ns = cljs.core.nth.call(null,vec__25892,(0),null);
var name = cljs.core.nth.call(null,vec__25892,(1),null);
var selector = cljs.core.nth.call(null,vec__25892,(2),null);
...
return (function (p__25896){
var vec__25897 = p__25896;
var munged_name = cljs.core.nth.call(null,vec__25897,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25897,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25897,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25895_SHARP_){
return (obj[cljs.core.first.call(null,p1__25895_SHARP_)]);
});})(name,sorted_matches,vec__25897,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1505990295922
