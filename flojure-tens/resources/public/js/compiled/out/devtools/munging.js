...
var o24277 = temp__6736__auto__;
var temp__6736__auto____$1 = (o24277["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o24278 = temp__6736__auto____$1;
return (o24278["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__13261__auto__ = f;
return (o__13261__auto__["toString"]).call(o__13261__auto__);
} else {
return "";
}
}catch (e24279){var _ = e24279;
return "";
}});
...
try{var o__13261__auto___24281 = t;
(o__13261__auto___24281["cljs$lang$ctorPrWriter"]).call(o__13261__auto___24281,t,writer);
}catch (e24280){var __24282 = e24280;
}
...
var char_code = (function (){var o__13261__auto__ = (new String(char$));
return (o__13261__auto__["charCodeAt"]).call(o__13261__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__13261__auto__ = String;
return (o__13261__auto__["fromCharCode"]).call(o__13261__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24283 = num_code;
switch (G__24283) {
case (1):
return (185);
...
var o__13261__auto__ = String;
return (o__13261__auto__["fromCharCode"]).call(o__13261__auto__,superscript_code);
});
/**
...
}catch (e24285){var _e__13268__auto__ = e24285;
return false;
}})())){
...
var vec__24286 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24286,(0),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var o24289 = temp__6736__auto__;
var temp__6736__auto____$1 = (o24289["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o24290 = temp__6736__auto____$1;
return (o24290["nameToPath"]);
} else {
return null;
}
} else {
...
var len__11087__auto___24297 = arguments.length;
var i__11088__auto___24298 = (0);
while(true){
if((i__11088__auto___24298 < len__11087__auto___24297)){
args__11094__auto__.push((arguments[i__11088__auto___24298]));

var G__24299 = (i__11088__auto___24298 + (1));
i__11088__auto___24298 = G__24299;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24293){
var vec__24294 = p__24293;
var ns_detector = cljs.core.nth.call(null,vec__24294,(0),null);
...
var G__24300 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24301 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24300;
remaining_tokens = G__24301;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24291){
var G__24292 = cljs.core.first.call(null,seq24291);
var seq24291__$1 = cljs.core.next.call(null,seq24291);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__24292,seq24291__$1);
});
...
var vec__24305 = cljs.core.split_with.call(null,(function (p1__24304_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24304_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24305,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24305,(1),null);
...
var vec__24308 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24308,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24308,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24311 = cljs.core.rest.call(null,remaining_tokens);
var G__24312 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24311;
name_tokens = G__24312;
continue;
} else {
...
var vec__24315 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24315,(0),null);
var arity = cljs.core.nth.call(null,vec__24315,(1),null);
var vec__24318 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24318,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24318,(1),null);
var vec__24321 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24321,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24321,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24321,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24321,(3),null);
...
var vec__24327 = result;
var munged_ns = cljs.core.nth.call(null,vec__24327,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24327,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24327,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24327,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24327,(4),null);
var arity = cljs.core.nth.call(null,vec__24327,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__24331 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__24331,(0),null);
var args = cljs.core.nth.call(null,vec__24331,(1),null);
var vec__24334 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24334,(0),null);
var name = cljs.core.nth.call(null,vec__24334,(1),null);
...
var G__24337 = (arity + (1));
var G__24338 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24339){
var vec__24340 = p__24339;
var arity = cljs.core.nth.call(null,vec__24340,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24340,(1),null);
...
return cljs.core.get.call(null,arities,p1__24343_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24344_SHARP_);
...
var args__11094__auto__ = [];
var len__11087__auto___24351 = arguments.length;
var i__11088__auto___24352 = (0);
while(true){
if((i__11088__auto___24352 < len__11087__auto___24351)){
args__11094__auto__.push((arguments[i__11088__auto___24352]));

var G__24353 = (i__11088__auto___24352 + (1));
i__11088__auto___24352 = G__24353;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24347){
var vec__24348 = p__24347;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24348,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24345){
var G__24346 = cljs.core.first.call(null,seq24345);
var seq24345__$1 = cljs.core.next.call(null,seq24345);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__24346,seq24345__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24356__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24356__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24356__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24356__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24357 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24357,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24357,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24357,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24357,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24357,(4),null);
var arity = cljs.core.nth.call(null,vec__24357,(5),null);
...
var o__13261__auto__ = f;
return (o__13261__auto__["getBasis"]).call(o__13261__auto__);
});
/**
...
}catch (e24361){var _e__13268__auto__ = e24361;
...
var G__24362 = (obj[cljs.core.first.call(null,path)]);
var G__24363 = cljs.core.rest.call(null,path);
obj = G__24362;
path = G__24363;
continue;
} else {
...
return (function (accum,p__24364){
var vec__24365 = p__24364;
var bit = cljs.core.nth.call(null,vec__24365,(0),null);
var protocol = cljs.core.nth.call(null,vec__24365,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24368){
var vec__24369 = p__24368;
var ns = cljs.core.nth.call(null,vec__24369,(0),null);
var name = cljs.core.nth.call(null,vec__24369,(1),null);
var selector = cljs.core.nth.call(null,vec__24369,(2),null);
...
return (function (p__24373){
var vec__24374 = p__24373;
var munged_name = cljs.core.nth.call(null,vec__24374,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24374,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24374,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24372_SHARP_){
return (obj[cljs.core.first.call(null,p1__24372_SHARP_)]);
});})(name,sorted_matches,vec__24374,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1504285966241
