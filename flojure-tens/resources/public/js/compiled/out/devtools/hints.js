...
var reader = (function (){var or__58161__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__58161__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
return (128);
...
var map__73322 = top_item;
var map__73322__$1 = ((((!((map__73322 == null)))?((((map__73322.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__73322.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__73322):map__73322);
var file = cljs.core.get.call(null,map__73322__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__73322__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__73322__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e73321){var _e = e73321;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6736__auto___73324 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6736__auto___73324)){
var seen_errors_73325 = temp__6736__auto___73324;
if(cljs.core.truth_(seen_errors_73325.has(self))){
} else {
seen_errors_73325.add(self);

var temp__6738__auto___73326 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6738__auto___73326)){
var sense_73327 = temp__6738__auto___73326;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_73327)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1505406798150
