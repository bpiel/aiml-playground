...
var file = cljs.core.get.call(null,map__26113__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26113__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26113__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26112){var _e = e26112;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6736__auto___26115 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6736__auto___26115)){
var seen_errors_26116 = temp__6736__auto___26115;
if(cljs.core.truth_(seen_errors_26116.has(self))){
} else {
seen_errors_26116.add(self);

var temp__6738__auto___26117 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6738__auto___26117)){
var sense_26118 = temp__6738__auto___26117;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26118)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1504285970144
