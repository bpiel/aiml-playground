...
var map__26345 = top_item;
var map__26345__$1 = ((((!((map__26345 == null)))?((((map__26345.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26345.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26345):map__26345);
var file = cljs.core.get.call(null,map__26345__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26345__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26345__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26344){var _e = e26344;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6736__auto___26347 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6736__auto___26347)){
var seen_errors_26348 = temp__6736__auto___26347;
if(cljs.core.truth_(seen_errors_26348.has(self))){
} else {
seen_errors_26348.add(self);

var temp__6738__auto___26349 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6738__auto___26349)){
var sense_26350 = temp__6738__auto___26349;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26350)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1506034941503
