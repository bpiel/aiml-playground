...
var line = cljs.core.get.call(null,map__27636__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__27636__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e27635){var _e = e27635;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6736__auto___27638 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6736__auto___27638)){
var seen_errors_27639 = temp__6736__auto___27638;
if(cljs.core.truth_(seen_errors_27639.has(self))){
} else {
seen_errors_27639.add(self);

var temp__6738__auto___27640 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6738__auto___27640)){
var sense_27641 = temp__6738__auto___27640;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27641)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1505990300265
