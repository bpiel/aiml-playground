...
var file = cljs.core.get.call(null,map__26296__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26296__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26296__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26295){var _e = e26295;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6736__auto___26298 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6736__auto___26298)){
var seen_errors_26299 = temp__6736__auto___26298;
if(cljs.core.truth_(seen_errors_26299.has(self))){
} else {
seen_errors_26299.add(self);

var temp__6738__auto___26300 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6738__auto___26300)){
var sense_26301 = temp__6738__auto___26300;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26301)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1505319637524
