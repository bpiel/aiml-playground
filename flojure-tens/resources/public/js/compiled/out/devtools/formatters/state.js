...
var len__59405__auto___114902 = arguments.length;
var i__59406__auto___114903 = (0);
while(true){
if((i__59406__auto___114903 < len__59405__auto___114902)){
args__59412__auto__.push((arguments[i__59406__auto___114903]));

var G__114904 = (i__59406__auto___114903 + (1));
i__59406__auto___114903 = G__114904;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__59413__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq114900){
var G__114901 = cljs.core.first.call(null,seq114900);
var seq114900__$1 = cljs.core.next.call(null,seq114900);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__114901,seq114900__$1);
});
...
return (function (p1__114905_SHARP_){
return (p1__114905_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1505927825064
