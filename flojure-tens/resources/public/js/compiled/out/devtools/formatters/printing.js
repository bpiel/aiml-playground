...
var len__59438__auto___71693 = arguments.length;
var i__59439__auto___71694 = (0);
while(true){
if((i__59439__auto___71694 < len__59438__auto___71693)){
args__59445__auto__.push((arguments[i__59439__auto___71694]));

var G__71695 = (i__59439__auto___71694 + (1));
i__59439__auto___71694 = G__71695;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__59446__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq71690){
var G__71691 = cljs.core.first.call(null,seq71690);
var seq71690__$1 = cljs.core.next.call(null,seq71690);
var G__71692 = cljs.core.first.call(null,seq71690__$1);
var seq71690__$2 = cljs.core.next.call(null,seq71690__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__71691,G__71692,seq71690__$2);
});
...
if(cljs.core.truth_((function (){var or__58161__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__58832__auto__,writer__58833__auto__,opt__58834__auto__){
return cljs.core._write.call(null,writer__58833__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__58149__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__58149__auto__){
var or__58161__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__71696_SHARP_){
return !((cljs.core.meta.call(null,p1__71696_SHARP_) == null));
})))){
...
var map__71697 = opts;
var map__71697__$1 = ((((!((map__71697 == null)))?((((map__71697.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71697.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__71697):map__71697);
var markup_db = cljs.core.get.call(null,map__71697__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__58161__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e71701){var _e__60657__auto__ = e71701;
return false;
}})();
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
...
}catch (e71703){var _e__60657__auto__ = e71703;
return false;
}}
})())){
...
var _STAR_current_state_STAR_71705 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__71706 = opts;
var map__71706__$1 = ((((!((map__71706 == null)))?((((map__71706.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__71706.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__71706):map__71706);
var markup_db = cljs.core.get.call(null,map__71706__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_71705;
}});
...
;
var temp__6736__auto___71710 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6736__auto___71710)){
var managed_print_level_71711 = temp__6736__auto___71710;
var _STAR_print_level_STAR_71709_71712 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_71711;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_71709_71712,managed_print_level_71711,temp__6736__auto___71710,writer,opts,job_fn){
return (function (p1__71708_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__71708_SHARP_,null);
});})(_STAR_print_level_STAR_71709_71712,managed_print_level_71711,temp__6736__auto___71710,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_71709_71712;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1505406794490
