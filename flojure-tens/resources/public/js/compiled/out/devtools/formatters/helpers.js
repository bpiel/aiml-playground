...
var G__71672 = devtools.prefs.pref.call(null,v);
v = G__71672;
continue;
} else {
return v;
...
var and__58149__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__58149__auto__){
var and__58149__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__58161__auto__ = (function (){try{if(!((value == null))){
...
}catch (e71675){var _e__60657__auto__ = e71675;
return false;
}})();
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
var or__58161__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e71679){var _e__60657__auto__ = e71679;
return false;
}})();
...
}catch (e71681){var _e__60657__auto__ = e71681;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__58149__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__58149__auto__)){
var and__58149__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__58149__auto____$1){
...
var and__58149__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__58149__auto__)){
...
var or__58161__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
...
var and__58149__auto__ = (function (){var or__58161__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__58161__auto__)){
return or__58161__auto__;
} else {
...
var vec__71683 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__71683,(0),null);
var name = cljs.core.nth.call(null,vec__71683,(1),null);
...
var and__58149__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__58149__auto__)){
...
var or__58161__auto__ = typeof value === 'string';
if(or__58161__auto__){
return or__58161__auto__;
} else {
var or__58161__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__71686_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__71686_SHARP_);
}),template);
});
...
var temp__6736__auto__ = devtools.formatters.helpers.pref.call(null,pref_key);
if(cljs.core.truth_(temp__6736__auto__)){
var render_pref = temp__6736__auto__;
if(render_pref === true){
...
//# sourceMappingURL=helpers.js.map?rel=1505406794383
