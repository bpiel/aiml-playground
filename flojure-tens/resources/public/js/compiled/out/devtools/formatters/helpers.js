...
var G__24652 = devtools.prefs.pref.call(null,v);
v = G__24652;
continue;
} else {
return v;
...
}catch (e24655){var _e__12364__auto__ = e24655;
return false;
}})();
...
}catch (e24659){var _e__12364__auto__ = e24659;
return false;
}})();
...
}catch (e24661){var _e__12364__auto__ = e24661;
return false;
}}
}
});
...
var vec__24663 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__24663,(0),null);
var name = cljs.core.nth.call(null,vec__24663,(1),null);
...
return cljs.core.some.call(null,(function (p1__24666_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24666_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1505751978726
