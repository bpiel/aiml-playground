...
var G__79204 = devtools.prefs.pref.call(null,v);
v = G__79204;
continue;
} else {
return v;
...
var and__64405__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__64405__auto__){
var and__64405__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__64417__auto__ = (function (){try{if(!((value == null))){
...
}catch (e79207){var _e__73240__auto__ = e79207;
return false;
}})();
if(cljs.core.truth_(or__64417__auto__)){
return or__64417__auto__;
} else {
var or__64417__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e79211){var _e__73240__auto__ = e79211;
return false;
}})();
...
}catch (e79213){var _e__73240__auto__ = e79213;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__64405__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__64405__auto__)){
var and__64405__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__64405__auto____$1){
...
var and__64405__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__64405__auto__)){
...
var or__64417__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__64417__auto__)){
return or__64417__auto__;
} else {
...
var and__64405__auto__ = (function (){var or__64417__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__64417__auto__)){
return or__64417__auto__;
} else {
...
var vec__79215 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__79215,(0),null);
var name = cljs.core.nth.call(null,vec__79215,(1),null);
...
var and__64405__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__64405__auto__)){
...
var or__64417__auto__ = typeof value === 'string';
if(or__64417__auto__){
return or__64417__auto__;
} else {
var or__64417__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__79218_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__79218_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1506558359256
