...
var G__24379 = devtools.prefs.pref.call(null,v);
v = G__24379;
continue;
} else {
return v;
...
}catch (e24382){var _e__13268__auto__ = e24382;
return false;
}})();
...
}catch (e24386){var _e__13268__auto__ = e24386;
return false;
}})();
...
}catch (e24388){var _e__13268__auto__ = e24388;
return false;
}}
}
});
...
var vec__24390 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__24390,(0),null);
var name = cljs.core.nth.call(null,vec__24390,(1),null);
...
return cljs.core.some.call(null,(function (p1__24393_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24393_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1504285966340
