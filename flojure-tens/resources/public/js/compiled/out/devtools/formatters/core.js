...
var and__58123__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__58123__auto__){
var or__58135__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e74058){var _e__66959__auto__ = e74058;
return false;
...
}catch (e74060){var _e__66959__auto__ = e74060;
return false;
...
}catch (e74062){var _e__66959__auto__ = e74062;
return false;
...
}catch (e74064){var _e__66959__auto__ = e74064;
return false;
...
}catch (e74066){var _e__66959__auto__ = e74066;
return false;
}})())){
...
}catch (e74068){var _e__66959__auto__ = e74068;
return false;
}})())){
...
var _STAR_current_state_STAR_74070 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__58135__auto__ = config;
if(cljs.core.truth_(or__58135__auto__)){
return or__58135__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_74070;
}});
});
...
while (G__74073__i < G__74073__a.length) {G__74073__a[G__74073__i] = arguments[G__74073__i + 0]; ++G__74073__i;}
  args = new cljs.core.IndexedSeq(G__74073__a,0,null);
} 
return G__74072__delegate.call(this,args);};
G__74072.cljs$lang$maxFixedArity = 0;
G__74072.cljs$lang$applyTo = (function (arglist__74074){
var args = cljs.core.seq(arglist__74074);
return G__74072__delegate(args);
});
G__74072.cljs$core$IFn$_invoke$arity$variadic = G__74072__delegate;
return G__74072;
})()
;
});
...
var pre_handler = (function (){var or__58135__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__58135__auto__)){
return or__58135__auto__;
} else {
...
var post_handler = (function (){var or__58135__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__58135__auto__)){
return or__58135__auto__;
} else {
return cljs.core.identity;
...
//# sourceMappingURL=core.js.map?rel=1506641523860
