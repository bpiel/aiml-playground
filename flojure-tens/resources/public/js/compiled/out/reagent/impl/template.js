...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__58832__auto__,writer__58833__auto__,opt__58834__auto__){
return cljs.core._write.call(null,writer__58833__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__60483 = o;
(G__60483[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__60484__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__60484 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__60485__i = 0, G__60485__a = new Array(arguments.length -  0);
while (G__60485__i < G__60485__a.length) {G__60485__a[G__60485__i] = arguments[G__60485__i + 0]; ++G__60485__i;}
  args = new cljs.core.IndexedSeq(G__60485__a,0,null);
} 
return G__60484__delegate.call(this,args);};
G__60484.cljs$lang$maxFixedArity = 0;
G__60484.cljs$lang$applyTo = (function (arglist__60486){
var args = cljs.core.seq(arglist__60486);
...
if(cljs.core.truth_((function (){var and__58149__auto__ = !((jsprops == null));
if(and__58149__auto__){
var and__58149__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__60489 = jsprops;
(G__60489["defaultValue"] = value);

(G__60489["onChange"] = ((function (G__60489,v,value,on_change){
return (function (p1__60488_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__60488_SHARP_);
});})(G__60489,v,value,on_change))
);
...
var vec__60492 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__60492,(0),null);
var id = cljs.core.nth.call(null,vec__60492,(1),null);
var class$ = cljs.core.nth.call(null,vec__60492,(2),null);
...
var jsprops = ({"argv": v});
var temp__6742__auto___60496 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6742__auto___60496 == null)){
} else {
var key_60497 = temp__6742__auto___60496;
(jsprops["key"] = key_60497);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__60498 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__60498["name"] = c);
...
var len__59438__auto___60503 = arguments.length;
var i__59439__auto___60504 = (0);
while(true){
if((i__59439__auto___60504 < len__59438__auto___60503)){
args__59445__auto__.push((arguments[i__59439__auto___60504]));

var G__60505 = (i__59439__auto___60504 + (1));
i__59439__auto___60504 = G__60505;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__59446__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq60501){
var G__60502 = cljs.core.first.call(null,seq60501);
var seq60501__$1 = cljs.core.next.call(null,seq60501);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__60502,seq60501__$1);
});
...
break;
default:
var G__60508 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__60508;
continue;
...
var n__59204__auto___60510 = a.length;
var i_60511 = (0);
while(true){
if((i_60511 < n__59204__auto___60510)){
(a[i_60511] = reagent.impl.template.as_element.call(null,(a[i_60511])));

var G__60512 = (i_60511 + (1));
i_60511 = G__60512;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__59204__auto___60513 = a.length;
var i_60514 = (0);
while(true){
if((i_60514 < n__59204__auto___60513)){
var val_60515 = (a[i_60514]);
if((cljs.core.vector_QMARK_.call(null,val_60515)) && ((reagent.impl.template.key_from_vec.call(null,val_60515) == null))){
(o["no-key"] = true);
} else {
}

(a[i_60514] = reagent.impl.template.as_element.call(null,val_60515));

var G__60516 = (i_60514 + (1));
i_60514 = G__60516;
continue;
} else {
}
...
var ctx = ({});
var vec__60517 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__60517,(0),null);
var derefed = cljs.core.nth.call(null,vec__60517,(1),null);
...
var G__60520 = (cljs.core.count.call(null,argv) - first_child);
switch (G__60520) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__60520){
...
//# sourceMappingURL=template.js.map?rel=1505406775489
