...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"ws-inbound","ws-inbound",994735957),(function (db,p__101109){
var vec__101110 = p__101109;
var _ = cljs.core.nth.call(null,vec__101110,(0),null);
var map__101113 = cljs.core.nth.call(null,vec__101110,(1),null);
var map__101113__$1 = ((((!((map__101113 == null)))?((((map__101113.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__101113.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__101113):map__101113);
var p = map__101113__$1;
var graph = cljs.core.get.call(null,map__101113__$1,new cljs.core.Keyword(null,"graph","graph",1558099509));
var charts = cljs.core.get.call(null,map__101113__$1,new cljs.core.Keyword(null,"charts","charts",555258811));
var selected = cljs.core.get.call(null,map__101113__$1,new cljs.core.Keyword(null,"selected","selected",574897764));
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"node-select","node-select",-1853167377),(function (db,p__101115){
var vec__101116 = p__101115;
var _ = cljs.core.nth.call(null,vec__101116,(0),null);
var node_id = cljs.core.nth.call(null,vec__101116,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"ws-send","ws-send",-1223872562),(function guildsman$core$ws_send(db,p__101119){
var vec__101120 = p__101119;
var _ = cljs.core.nth.call(null,vec__101120,(0),null);
var data = cljs.core.nth.call(null,vec__101120,(1),null);
...
re_frame.core.reg_event_db.call(null,new cljs.core.Keyword(null,"click-chart","click-chart",1609816313),(function (db,p__101123){
var vec__101124 = p__101123;
var _ = cljs.core.nth.call(null,vec__101124,(0),null);
var idx = cljs.core.nth.call(null,vec__101124,(1),null);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.summary","div.summary",-765334266),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.title","span.title",-1997593088),title], null),(function (){var G__101127 = ty;
var G__101127__$1 = (((G__101127 instanceof cljs.core.Keyword))?G__101127.fqn:null);
switch (G__101127__$1) {
case "chart":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__101127__$1)].join('')));
...
return (function (i,p__101129){
var vec__101130 = p__101129;
var ty = cljs.core.nth.call(null,vec__101130,(0),null);
var title = cljs.core.nth.call(null,vec__101130,(1),null);
var data = cljs.core.nth.call(null,vec__101130,(2),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.summary-outer","div.summary-outer",575360463),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__101130,ty,title,data,charts){
return (function (){
...
});})(vec__101130,ty,title,data,charts))
...
var vec__101133 = cljs.core.nth.call(null,charts,left_mode);
var ty = cljs.core.nth.call(null,vec__101133,(0),null);
var title = cljs.core.nth.call(null,vec__101133,(1),null);
var data = cljs.core.nth.call(null,vec__101133,(2),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#big-left","div#big-left",1289679938),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__101133,ty,title,data,left_mode,charts){
return (function (){
...
});})(vec__101133,ty,title,data,left_mode,charts))
