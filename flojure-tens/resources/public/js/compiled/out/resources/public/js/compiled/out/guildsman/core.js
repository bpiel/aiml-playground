...
return cljs.core.println.call(null,m);
});
...
guildsman.core.dispatch_ws_msg = (function guildsman$core$dispatch_ws_msg(p__2973339){
var map__2973340 = p__2973339;
var map__2973340__$1 = ((((!((map__2973340 == null)))?((((map__2973340.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2973340.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2973340):map__2973340);
var msg = map__2973340__$1;
var cmd = cljs.core.get.call(null,map__2973340__$1,new cljs.core.Keyword(null,"cmd","cmd",-302931143));
var G__2973342 = cmd;
var G__2973342__$1 = (((G__2973342 instanceof cljs.core.Keyword))?G__2973342.fqn:null);
switch (G__2973342__$1) {
case "graph":
return guildsman.core.init_cyto.call(null,cmd);

break;
case "chart":
return guildsman.core.chart.call(null,cmd);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__2973342__$1)].join('')));
...
//# sourceMappingURL=core.js.map?rel=1504729881978
