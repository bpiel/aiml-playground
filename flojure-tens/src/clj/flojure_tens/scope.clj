...
#_(defn try-reuse-var-scope
  [default-scope old-scope]
  (if (:reuse? old-scope)
    old-scope
    (push-var-scope* old-scope
                     default-scope)))

#_(defmacro with-reuse-var-scope
  [default-scope & body]
  `(binding [*var-scope* (try-reuse-var-scope ~default-scope
                                              *var-scope*)]
     ~@body))
